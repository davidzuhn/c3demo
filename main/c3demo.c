...
bleprph_gap_event(struct ble_gap_event *event, void *arg)
{
    ...
    case BLE_GAP_EVENT_CONNECT:
        ...
        ESP_LOGI(TAG, "connection %s; status=%04x ",
        ...
        /* Remember peer. */
        ESP_LOGI(TAG, "adding peer %d", event->connect.conn_handle);
...
#define DISCOVER_ON_PEER 1
    ...
    case BLE_GAP_EVENT_DISCONNECT:
        ESP_LOGI(TAG, "disconnect; reason=%04x ", event->disconnect.reason);
    ...
    case BLE_GAP_EVENT_CONN_UPDATE:
        ...
        ESP_LOGI(TAG, "connection updated; status=%04x ",
    ...
    case BLE_GAP_EVENT_ADV_COMPLETE:
        ESP_LOGI(TAG, "advertise complete; reason=%04x",
    ...
    case BLE_GAP_EVENT_ENC_CHANGE:
        ...
        ESP_LOGI(TAG, "encryption change event; status=%04x ",
    ...
    case BLE_GAP_EVENT_SUBSCRIBE:
        ESP_LOGI(TAG, "subscribe event; conn_handle=%d attr_handle=%d "
                    "reason=%04x prevn=%d curn=%d previ=%d curi=%d",
...
{
    ESP_LOGE(TAG, "Resetting state; reason=%04x", reason);
}
...
initialize_ble()
{
    ...
    rc = ble_svc_gap_device_name_set("DEMOSTHENES");
    assert(rc == 0);
